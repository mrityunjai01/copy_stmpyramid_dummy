...
class Node:
    ...
    def store_weight(self):
        ...
        if(self.path != None):
            ...
            directory = 'solver='+str(self.sol_name)+'_Tree_Height='+str(self.tree_height)+'_C='+str(self.C)+'_rank='+str(self.rank) + '_constrain=' + str(self.constrain) + '_wnorm=' + str(self.wnorm) + '_decomp=' + str(self.decomp) + '_tuneC=' + str(self.tuneC) + '_decomprank=' + str(self.decomprank)
